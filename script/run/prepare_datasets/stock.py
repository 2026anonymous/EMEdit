...
# read 
df_train = pd.read_csv('../data/stock/train.csv.zip', compression='zip')
df_test =  pd.read_csv('../data/stock/test.csv.zip', compression='zip')
df_left =  pd.read_csv('../data/stock/left.csv.zip', compression='zip')
...
args0 = {'Macroeconomics': None,
         'Emergency': None,
        }

args1 = {'Macroeconomics': [('Emergency', 'Quiet market environment')],
        'Emergency': [('Macroeconomics', 'Negative macro')]
        }

args_ls = [args0, args1]

# Define the base augmentation pairs used in math and ts_dist
base_aug_dict = {'Macroeconomics': [('Negative macro', 'No macroeconomic development'),
                                    ('Negative macro', 'Positive macro'),
                                    ('No macroeconomic development', 'Negative macro'),
                                    ('No macroeconomic development', 'Positive macro'),
                                    ('Positive macro', 'Negative macro'),
                                    ('Positive macro', 'No macroeconomic development'),
                                    ],
                'Emergency': [('Quiet market environment', 'Sudden event shock'),
                              ('Sudden event shock', 'Quiet market environment')],
                }
