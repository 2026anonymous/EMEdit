...
config_dict = {
    ...
    'batch_size': 512,
    'text_encoder_name': 'Qwen/Qwen3-Embedding-4B',#'sentence-transformers/all-mpnet-base-v2',Qwen/Qwen3-Embedding-4B,'nvidia/llama-nemotron-embed-1b-v2','Qwen/Qwen3-Embedding-0.6B'
    'ts_encoder_name': 'hr_vae_linear_medium',  #'hr_vae_linear_medium'
    ...
    'target_ratio': 10, # gamma: target ratio (clip loss over rc loss)
